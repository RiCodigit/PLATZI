...
-- CONTENIDO PARA LAS TABLAS --


-- ----------------------------  --

INSERT INTO usuarios (`id`,`login`,`password`,`nickname`,`email`) VALUES (1,'israel','jc8209','Israel','israel@platziblog.com');
INSERT INTO usuarios (`id`,`login`,`password`,`nickname`,`email`) VALUES (2,'monica','mn8988','Moni','monica@platziblog.com');
INSERT INTO usuarios (`id`,`login`,`password`,`nickname`,`email`) VALUES (3,'laura','lau8767','Lau','laura@platziblog.com');
INSERT INTO usuarios (`id`,`login`,`password`,`nickname`,`email`) VALUES (4,'edgar','lil9089','Ed','edgar@platziblog.com');
INSERT INTO usuarios (`id`,`login`,`password`,`nickname`,`email`) VALUES (5,'perezoso','sos9876','Oso Pérez','perezoso@platziblog.com');
...
-- Posts-etiquetas
 ...
 /* 
  ...
  -- FALTA EJECUTAR LAS LINEAS DE A BAJO, HAY UN PROBLEMA CON LA TABLA POSTS_ETIQUETAS
  -- soluciones: lo mas rapido es borrar la tabla y crearla con lo hacen en el curso.
 
 Error Code: 1452. Cannot add or update a child row: a foreign key constraint fails 
 (`platziblog`.`posts_etiquetas`, CONSTRAINT `postEtiquetas_etiquetas` 
...
Borro todo y lo creo de nuevo. ya que el codigo anterior tenia problemas
por que al crear las algunas tablas, se les había puesto el atributo not null
y al insertar valores en dichas tablas , algunos campos quedaban vacios, es por eso
que me daba errores, la formas mas rapida para solucionarlo es la que hice mas a bajo
a mi modo de ver, con mis actuales conocimientos.
...
-- Nota: Si se quiere tener la base de datos igual a la clase 29 solo hay que ejecutar las lineas de mas a bajo.
Esto es util si vas a empezar a ver el modulo dedicado a las consultas de bases de datos.
...
-- Sentencia SELECT , usada para mostrar datos. 

-- Ejercicio 1: Mostramos todos los datos de los posts.
SELECT *
FROM posts;

-- Ejer 2: Mostramos solo 3 datos.
SELECT titulo, fecha_publicacion, estatus
FROM posts;


-- Ejer 3: Como cambiar el nombre de los datos que pedimos: Usamos AS
SELECT titulo as encabezado, fecha_publicacion as publicado_en , estatus as estado
FROM posts;

-- Ejer 4: Agrupacion. Mostrar usando Count(*) , es decir , mostra todos los registros de contandolos y devolviendo el valor de la suma. 
SELECT COUNT(*)
FROM posts;

-- Ejer 4.1: Lo mismo pero con un alias mas legible.
